...
binding.context.errorHandler        = function(handle, errorCode, unknown) { module.exports.emit("error", handle, errorCode, unknown); };
binding.context.inputChangeHandler  = function(handle, index, state) { module.exports.emit("inputChange", handle, index, state); };
binding.context.outputChangeHandler  = function(handle, index, state) { module.exports.emit("outputChange", handle, index, state); };
